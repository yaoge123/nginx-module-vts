...
[
    ...
    'GET /status/control?cmd=reset&group=server&zone=localhost',
]
...
[
    ...
    'GET /status/control?cmd=reset&group=filter&zone=storage::localhost@vol0',
]
--- response_body_like eval
[
    'OK',
...
[
    ...
    'GET /status/control?cmd=reset&group=upstream@group&zone=backend@127.0.0.1:80',
]
--- response_body_like eval
[
    'OK',
...
[
    'GET /backend/file.txt',
    'GET /status/control?cmd=reset&group=upstream@alone&zone=127.0.0.1:1981',
]
--- response_body_like eval
[
    'OK',
...
[
    'GET /one/file.txt',
    'GET /two/file.txt',
    'GET /status/control?cmd=reset&group=cache&zone=cache_one'
]
--- response_body_like eval
[
    'OK',
